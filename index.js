...
var selectedCells = [];
var count=0;
var words=['MOHAMUDGAARA','ARSIMANADNAM','SRINGERI','TOTAKA','SANKARA','DWARAKA','PURNA','SIVAGURU',
'GOVINDAPADA','ARYAMBA','BHAJAGOVINDAM','MUTTS','PURI','BADRI','ADVAITA',
'ARAAGDUMAHOM','MANDANAMISRA','IREGNIRS','AKATOT','ARAKNAS','AKARAWD','ANRUP','URUGAVIS','ADAPADNIVOG','ABMAYRA','MADNIVOGAJAHB',
'STTUM','IRUP','IRDAB','ATIAVDA'
]
const WordMatrix = [
...
function handleMouseMove(event) {
    ...
    function selectCell(cell) {
        ...
        selectedCells.push(cell); // Add cell to the selected cells array
        }
